...
class Vaimo_Klarna_Model_Payment_Invoice extends Vaimo_Klarna_Model_Payment_Abstract
{
    protected $_code = Vaimo_Klarna_Helper_Data::KLARNA_METHOD_INVOICE;
    protected $_formBlockType = 'klarna/form_invoice';
    protected $_infoBlockType = 'klarna/info_invoice';
